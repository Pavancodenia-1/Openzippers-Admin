                    ...
                    <div class="form-row">
                        ...
                        <div class="col-xl-12">
                            <div class="row">
                                ...
                                @if ($mode == 'edit' || $mode == 'create')
                                <x-inputs.input-field class="col-xl-4 mb-3" label="Artist Amount" name="artist_amount" type="number"
                                    :value="old('artist_amount', $mode == 'edit' ? $transactions->artist_amount : '')" />
                                @else
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label mt-0" for="artist_amount">Artist Amount</label>
                                    <p class="form-control">{{ $transactions->artist_amount }}</p>
                                </div>
                                @endif

                                @if ($mode == 'edit' || $mode == 'create')
                                <x-inputs.input-field class="col-xl-4 mb-3" label="nowpayments_payment_id" name="Nowpayments Payment Id" type="number"
                                ...
                                @if ($mode == 'edit' || $mode == 'create')
                                <x-inputs.input-field class="col-xl-4 mb-3" label="nowpayments_order_id" name="Nowpayments Order Id" type="number"
                                ...
                                @if ($mode == 'edit' || $mode == 'create')
                                <x-inputs.input-field class="col-xl-4 mb-3" label="Updated At" name="updated_at" type="text"
                                    :value="old('updated_at', $mode == 'edit' ? $transactions->updated_at : '')" />
                                @else
                                <div class="col-xl-4 mb-3">
                                    <label class="form-label    mt-0" for="updated_at">Updated At</label>
                                    <p class="form-control">{{ $transactions->updated_at }}</p>
                                @endif
